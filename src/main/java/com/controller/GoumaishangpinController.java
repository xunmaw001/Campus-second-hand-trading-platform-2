...
public class GoumaishangpinController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,GoumaishangpinEntity goumaishangpin, HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("shangjia")) {
			goumaishangpin.setShangjiahao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("yonghu")) {
			goumaishangpin.setYonghuming((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,GoumaishangpinEntity goumaishangpin, HttpServletRequest request){
        EntityWrapper<GoumaishangpinEntity> ew = new EntityWrapper<GoumaishangpinEntity>();
    	PageUtils page = goumaishangpinService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, goumaishangpin), params), params));
		request.setAttribute("data", page);
        return R.ok().put("data", page);
