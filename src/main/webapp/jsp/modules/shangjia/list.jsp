...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="shangjiahaoSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('shangjiaxingming')">商家姓名<i id="shangjiaxingmingIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#shangjiahaoSearch').val() != null && $('#shangjiahaoSearch').val() != ''){
				searchForm.shangjiahao ="%" +  $('#shangjiahaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("shangjia/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
				shangjiahao : searchForm.shangjiahao,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var shangjiaxingmingCell  = document.createElement('td');

						 shangjiaxingmingCell.innerHTML = item.shangjiaxingming;


			row.appendChild(shangjiaxingmingCell);
