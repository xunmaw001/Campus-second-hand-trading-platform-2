...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>商家姓名</label>
										<input id="shangjiaxingming" name="shangjiaxingming" class="form-control" placeholder="商家姓名">
									</div>
									<div class="form-group col-md-6">
										<label>头像</label>
	...
	<script>
		...
		function dataBind(){
			...
			$("#shangjiaxingming").val(ruleForm.shangjiaxingming);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.shangjiaxingming != null && res.data.shangjiaxingming != ''){

					$("#shangjiaxingming").val(res.data.shangjiaxingming);
					}
