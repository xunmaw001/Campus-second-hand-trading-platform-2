						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>商品详情</label>
										<textarea name="shangpinxiangqing" class="form-control" id="shangpinxiangqing" rows="3"></textarea>
									</div>
									<div class="form-group col-md-6">
										<label>发布日期</label>
	...
	<script>
		...
		var shangpinleixingOptions = [];
				...
				function shangpinleixingSelect(){
					http("option/shangpinleixing/shangpinfenlei","GET",{},(res)=>{
						if(res.code == 0){
			...
			function fill(){
				...
				http(accountTableName+'/session','GET',{},(res)=>{
					if(res.code == 0){
						...
						if(res.data !=null && res.data.shangjiahao != null && res.data.shangjiahao != ''){
