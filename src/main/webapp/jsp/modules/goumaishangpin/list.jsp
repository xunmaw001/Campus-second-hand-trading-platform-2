...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">购买商品管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>购买商品管理</span></li>
								<li class="breadcrumb-item active"><span>购买商品列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">购买商品列表</h3>							
	...
	<script>
		...
		function setDataRow(item,number){
            ...
            crossBtn1.innerHTML = "商品发货"
			crossBtn1.setAttribute("type","button");
			crossBtn1.setAttribute("class","btn btn-primary btn-sm");
			crossBtn1.setAttribute("onclick","crossTable(" + item.id + ",\"shangpinfahuo\")");
			if(crossBtnControl('商品发货') == true){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("goumaishangpin/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function getSum(colName){
			http("goumaishangpin"+colName,"GET",{
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"goumaishangpin");
        ...
        function pay(id){
			...
			window.sessionStorage.setItem('tableName',"goumaishangpin");
