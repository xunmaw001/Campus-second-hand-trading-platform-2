  ...
  <div id="app">
      ...
      <form class="layui-form" style="margin: 10px 0;">
        <div class="layui-inline">
          ...
          <div class="layui-input-inline">
            <input type="text" name="fahuodanhao" id="fahuodanhao" placeholder="发货单号" autocomplete="off" class="layui-input">
          </div>
        </div>   
        <div class="layui-inline">
        ...
        <div class="layui-inline" style="margin-left: 30px;">
          ...
          <button v-if="isAuth('shangpinfahuo','新增')" @click="jump('../shangpinfahuo/add.jsp')" type="button" class="layui-btn btn-theme">
    ...
    <div class="product">
      <div class="proBox" v-for="(item,index) in dataList" v-bind:key="index">
        ...
        <div class="proBoxtxt">
          <a :href="'../shangpinfahuo/detail.jsp?id='+item.id">查看详情</a>
        </div>
      </div>
      <div class="clear"></div>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#fahuodanhao').val()) {
          param['fahuodanhao'] = jquery('#fahuodanhao').val() ? '%' + jquery('#fahuodanhao').val() + '%' : '';
        }  
        if (jquery('#yonghuming').val()) {
          param['yonghuming'] = jquery('#yonghuming').val() ? '%' + jquery('#yonghuming').val() + '%' : '';
        }  
        // 获取列表数据
        http.request('shangpinfahuo/list', 'get', param, function(res) {
