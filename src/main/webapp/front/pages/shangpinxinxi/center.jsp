				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="chengse" id="chengse" placeholder="成色" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="shangpinxiangqing" id="shangpinxiangqing" placeholder="商品详情" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
					...
					error: function() {
						...
						layer.msg("请求接口异常", {
							...
							icon: 5
																...
																http.request(`option/shangpinleixing/shangpinfenlei`,'get',{},(res)=>{
